...
const Card = ({ id, imageUrl, description, price, offer }) => {
  ...
  return (
    <div className="max-w-md rounded overflow-hidden shadow-lg relative">
      ...
      <div className="px-6 mb-4">
        <button
          className="bg-blue-500 hover:bg-blue-700 hover:shadow-sm text-white font-bold py-2 px-4 rounded"
